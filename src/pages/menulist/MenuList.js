...
import React, { useState } from 'react'
    ...
    const MenuList = () => {
      ...
      return (
        <Layout>
            <div className='p-7'>
            <img src={MenuListHeroImg} className="object-cover" alt="menulistheroimage"/>
           
            <div className=' grid grid-cols-12 gap-3 mt-5 md:mt-8'>
                <div className='col-span-2'>
                <img src={Services} alt="services" className='m-0'/>
                <ul className="flex flex-col  justify-between items-center bg-white font-light text-base"
                    style={{ boxShadow: "0px 1px 8px rgba(0, 0, 0, 0.08)" }}>
                <TabNavItem title="OrderAgain" id="tab2" activeTab={activeTab} setActiveTab={setActiveTab}/>
